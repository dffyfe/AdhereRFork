...
var adh_svg = { // begin namespace
  ...
  exists_legend : function() {
    x = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' #legend');
    return !(!x || x.length < 1);
  },
  ...
  list_items[i].addEventListener('click', function(e){
    ...
    if (GraphIndex > 1) {
      ...
      if(adh_svg.exists_alternating_bands()) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_alt_bands'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_alternating_bands(); }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_alt_bands'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_alt_bands'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_alt_bands'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_axis_names()["x"]) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_x_axis_name'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_axis_names()["x"]; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_x_axis_name'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_x_axis_name'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_x_axis_name'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_axis_labels()["x"]) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_x_axis_labels'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_axis_labels()["x"]; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_x_axis_labels'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_x_axis_labels'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_x_axis_labels'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_axis_names()["y"]) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_y_axis_name'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_axis_names()["y"]; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_y_axis_name'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_y_axis_name'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_y_axis_name'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_axis_labels()["y"]) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_y_axis_labels'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_axis_labels()["y"]; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_y_axis_labels'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_y_axis_labels'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_y_axis_labels'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_title()) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_title'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_title(); }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_title'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_title'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
      ...
      if(adh_svg.exists_legend()) {
        ...
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_legend'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_legend'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_fuw()) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_fuw'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_fuw(); }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_fuw'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_fuw'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_fuw'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_ow()) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_ow'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_ow(); }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_ow'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_ow'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_ow'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };

      if(adh_svg.exists_ow_real()) {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_ow_real'); if(tmp) { tmp.disabled = false; tmp.checked = adh_svg.is_visible_ow_real(); }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_ow_real'); if(tmp) { tmp.disabled = false; tmp.style = adh_svg.label_style_default; }
      } else {
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .button_toggle_ow_real'); if(tmp) { tmp.disabled = true; tmp.checked = false; }
        tmp = document.querySelector('.tabcontent.graph.index' + GraphIndex + ' .label_toggle_ow_real'); if(tmp) { tmp.disabled = true; tmp.style = adh_svg.label_style_disabled; }
      };
